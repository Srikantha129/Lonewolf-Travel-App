...
import 'package:lonewolf/models/travel_locations.dart';
import 'package:url_launcher/url_launcher.dart';
import '../pages/trip/trip_main.dart';
...
class SelectPersonalizeRoute extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final recommendedList = place.toList()..shuffle(); // Use the entire list
    ...
    return WillPopScope(
      ...
      bool? confirmExit = await showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          content: const Text("Do you want to save your itinerary? Once saved, you won't be able to add more destinations."),
          actions: [
            TextButton(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                          image: NetworkImage(item.photoUrls.first),
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
                ...
                onPressed: () {
                  Navigator.push(
                    ...
                    PageTransition(
                      duration: const Duration(milliseconds: 700),
                      type: PageTransitionType.fade,
                      child: TripMain(randomString: randomString,
